...
<head>
  ...
  <title>Restaurant Login Forms</title>
            ...
            <form role="form" class="text-start" method="post" action="{{ route('r_login') }}">
              @csrf
                ...
                <div class="text-center">
                    <button type="submit" class="btn" style="width: 50%; border-radius: 20px; background-color:#082A44; color:#ffffff">Login</button> 
                    <div class="row justify-content-center">
                        <div class="col text-center">
                            <h2 class="d-inline small">No account?</h2>
                            <span class="d-inline small" style="color: #002dce;"></span>
                            <a href="/register-restaurant" class="d-inline small" style="color: #002dce; font-weight: bold;">Register Account</a>
                        </div>
                    </div>
                </div><br>
            </form>
