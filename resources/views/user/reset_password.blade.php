        ...
        <div class="col-md-8 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body text-center" style="font-size:15px">
                    <form method="POST" action="{{ route('resetUserPasswordPost') }}" id="resetPasswordForm">
                        @csrf
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                            <div class="col-md-6">
                                <input style="font-size:15px; border-radius: 15px;" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
